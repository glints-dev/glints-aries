...
import {
  ...
  StyledItemList,
  StyledUnorderedList,
} from './IconStoriesStyles';
import { Icon } from './Icon';
import * as Colors from '../utilities/colors';

<Meta title="@next/Icon" />
...
- import NIcon component from glints-aries and pass name prop to use the specific ico
...
export const MyComponent = () => <Icon name="ri-account-circle-fill" />;
```
...
export const MyComponent = () => <StyledIcon name="ri-account-circle-fill" />;
```
...
3. Update `./src/@next/Icon/icons/icons.ts` file.
