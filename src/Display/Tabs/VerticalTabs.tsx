...
const VerticalTabs: Tabs = ({activeTab, onTabClick, children, className}) => {
  ...
  return (
    <TabsContainer className={classNames('aries-tabs-vertical', className)}>
      <TabsHeader className="tabs-header">
        <ul className="tabs-list-vertical" role="tablist">
