...
const generateWarningMessage = (messageProps: IMessageProps) => {
  return generateInvalidPropValueMessage(messageProps.component) + 
...
const makeShowWarningMessage = (defaultMessageProps: IDefaultMessageProps) => (messageProps: IMessageProps) => 
  console.warn(generateWarningMessage({...messageProps, ...defaultMessageProps}))

const makeReducerToPairWarningMessagesWithShowMessageFn = (defaultMessageProps: IDefaultMessageProps) => {
  const showWarningMessageWithDefaultProps = makeShowWarningMessage(defaultMessageProps)
