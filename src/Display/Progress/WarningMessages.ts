...
const defaultWarningMessageProps = { 
  component: 'progress',
  documentationURL: 'http://glints-aries.surge.sh/?selectedKind=Display&selectedStory=Progress&full=0',
}
...
export const warningMessages = generateWarningMessages(warningMessageTypes, defaultWarningMessageProps) as ProgressWarningMessageTypes
