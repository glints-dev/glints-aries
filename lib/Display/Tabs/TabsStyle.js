...
exports.TabsHeader = exports.TabsContent = exports.TabsContainer = exports.TabsBody = void 0;
...
var TabsHeader = _styledComponents["default"].div.withConfig({
  ...
  if (alignment === _StyleConfig.ETabAlignment.VERTICAL && isNewTab(theme)) {
    return "\n            @media (min-width: " + _StyleConfig.ScreenSize.tablet + "px) {\n              border-bottom: 0;\n              border-right: 4px solid rgba(1, 126, 183, 0.5);\n            }\n          ";
  }
}, "(min-width: " + _StyleConfig.ScreenSize.desktopS + "px)");

exports.TabsHeader = TabsHeader;

var TabsContent = _styledComponents["default"].div.withConfig({
  displayName: "TabsStyle__TabsContent",
  componentId: "sc-t1kk7p-2"
})(["position:relative;outline:none;@media (min-width:", "px){&.tabs-item-vertical{margin-left:60px;}}"], _StyleConfig.ScreenSize.tablet);

exports.TabsContent = TabsContent;

var TabsBody = _styledComponents["default"].div.withConfig({
