...
var Select = function Select(props) {
  ...
  React.useEffect(function updateOptionsAndActiveIndex() {
    ...
    if (!isFocus) {
      var selectedOptionIndex = availableOptions.findIndex(function (option) {
        return (0, _toLower["default"])(option.props.children).includes((0, _toLower["default"])(inputValue));
      });
  ...
  var handleClickOnOption = React.useCallback(function (e) {
    ...
    var activeElementIndex = Number((0, _get["default"])(activeElement, 'dataset.id'));
    var activeChild = options[activeElementIndex];
    var onOptionClick = (0, _get["default"])(activeChild, 'props.onOptionClick');
  ...
  if (shouldShowError) {
    if (renderError) {
      ...
      completeError = /*#__PURE__*/React.createElement(_SelectStyle.SelectErrorDefault, {
        className: "select-error-default"
      }, error);
    }
  }

  return /*#__PURE__*/React.createElement(_SelectStyle.SelectContainer, {
    className: (0, _classnames["default"])('aries-select', className),
    ref: selectContainerRef
  }, /*#__PURE__*/React.createElement(_SelectStyle.SelectWrapper, {
    className: "select-inputwrapper",
    isFocus: isFocus,
    small: small
  }, /*#__PURE__*/React.createElement(_SelectStyle.SelectInput, (0, _extends2["default"])({
    ref: selectInputRef,
    type: "text",
  ...
  }, defaultProps)), !removeFloatingLabel && /*#__PURE__*/React.createElement(_SelectStyle.SelectLabel, {
    "aria-label": label,
    ...
    color: "#777777"
  }))), /*#__PURE__*/React.createElement(_SelectList["default"], {
