...
})(["position:absolute;display:flex;right:1em;cursor:pointer;svg{fill:#666666;}&:hover svg{fill:", ";}"], _Colors.Greyscale.black);

exports.IconContainer = IconContainer;

var StartIconContainer = _styledComponents["default"].div.withConfig({
...
var TextFieldInput = _styledComponents["default"].input.withConfig({
  ...
  if (hasStartIcon) {
    return "\n          + " + StartIconContainer + " {\n            svg {\n              fill: " + _Colors.SecondaryColor.actionblue + ";\n            }\n          }\n        ";
  }
}, TextFieldLabel, function (_ref15) {
  var small = _ref15.small;
  return small ? 'translate3d(-10px, -20px, 0)' : 'translate3d(-15px, -20px, 0)';
}, _Colors.Greyscale.white, _Colors.Greyscale.softgrey, TextFieldLabel, _Colors.Greyscale.grey);
