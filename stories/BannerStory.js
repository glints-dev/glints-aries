...
const BannerStory = () => (
  <div className="doc-mainbar">
    <div style={{ marginBottom: '2em' }}>
      ...
      <p>
        <code>
          {'import { Banner } from \'glints-aries\''}
        </code>
      </p>
    </div>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <pre>
              <code>
                {'<Banner imgUrl={\'url\'} theme="red" label="apply" />'}
              </code>
            </pre>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <pre>
              <code>
                {'<Banner imgUrl={\'url\'} theme="blue" label="apply" />'}
              </code>
            </pre>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <pre>
              <code>
                {'<Banner imgUrl={\'url\'} theme="yellow" label="apply" />'}
              </code>
            </pre>
          </td>
        </tr>
