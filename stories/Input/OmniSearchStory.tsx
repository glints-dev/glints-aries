  ...
  >
    <div style={{ marginBottom: '10em' }}>
      ...
      >
        <OmniSearch.Body>
          <OmniSearch.List title="Karir Populer">
            <OmniSearch.Item>Business Development/ Sales</OmniSearch.Item>
            <OmniSearch.Item>Software Engineering</OmniSearch.Item>
            <OmniSearch.Item>Design</OmniSearch.Item>
          </OmniSearch.List>
          <OmniSearch.List title="Lokasi Populer">
            <OmniSearch.Item>
          ...
          <OmniSearch.List title="Perusahaan Populer">
            ...
            <OmniSearch.Item>
              <img
                src="http://sp.beritasatu.com/media/images/original/20140925164546835.jpg"
                width="40"
                height="40"
                alt="traveloka"
              />{' '}
            ...
            <OmniSearch.Item>
              <img
                src="https://ecs7.tokopedia.net/img/microsite-brand-resource/logo-tokopedia-asset.png"
                width="40"
                height="40"
                alt="traveloka"
              />{' '}
