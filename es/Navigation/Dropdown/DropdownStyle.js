...
export var DropdownHeader = styled.div.withConfig({
  ...
  return disabled && "" + Greyscale.grey;
}, function (_ref3) {
  ...
  return disabled ? Greyscale.grey : iconDefaultColor;
});
export var DropdownBody = styled.ul.withConfig({
...
}, Greyscale.white, Shadow.down3, function (_ref9) {
...
export var DropdownItemWrapper = styled.li.withConfig({
  ...
  return null;
}, Greyscale.softgrey, DropdownHeader, underLine);
