...
}, Greyscale.white, function (_ref5) {
  var floating = _ref5.floating;
  return floating ? "" + Greyscale.black : "" + Greyscale.grey;
}, function (_ref6) {
...
export var SelectInput = styled.input.withConfig({
  ...
  return status === 'error' ? "2px solid " + PrimaryColor.glintsred : "2px solid " + Greyscale.grey;
}, function (_ref13) {
  var small = _ref13.small;
  return small ? '1em' : '1.1em';
}, Greyscale.grey, function (_ref14) {
...
}, Greyscale.softgrey, SelectLabel, function (_ref16) {
  var floating = _ref16.floating;

  if (!floating) {
    return "\n              background: transparent;\n            ";
  }
}, Greyscale.grey, Greyscale.lightgrey, SecondaryColor.actionblue, function (_ref17) {
...
}, SecondaryColor.actionblue, function (_ref19) {
...
}, Greyscale.black, function (_ref21) {
...
}, Greyscale.white, Shadow.down3, function (_ref26) {
